                              ...
                              <Table aria-label='simple table' style={{ tableLayout: 'fixed' }}>
                                <TableHead>
                                  <TableRow>
                                    ...
                                    {dietDetails?.day_wise_data?.length &&
                                      dietDetails?.day_wise_data[0]?.meal_types?.ingredient?.length &&
                                      dietDetails?.day_wise_data[0]?.meal_types?.ingredient[0].meal_type?.map(
                                        (item, index) => (
                                          <TableCell
                                            key={index}
                                            sx={{
                                              ...
                                              borderRight:
                                                index + 1 ===
                                                dietDetails?.day_wise_data[0]?.meal_types?.ingredient[0].meal_type
                                                  ?.length
                                                  ? null
                                                  : '1px solid #C3CEC7'
                                            }}
