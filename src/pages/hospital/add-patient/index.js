                  ...
                  render={({ field }) => (
                    <Box sx={{ display: 'flex', flexDirection: { sm: 'row', xs: 'column' }, gap: 6 }}>
                      <TreatmentTypeRadioButtons
                        ...
                        isSelected={field.value === 'opd'}
                        onClick={() => field.onChange('opd')}
                      />
                      <TreatmentTypeRadioButtons
                        label='Hospital Admission (inpatient)'
                        isSelected={field.value === 'inpatient'}
                        onClick={() => field.onChange('inpatient')}
                      />
                      <TreatmentTypeRadioButtons
                        label='In site treatment'
                        isSelected={field.value === 'onsite'}
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Grid container spacing={4} sx={{ background: '#AFEFEB29', p: 6, borderRadius: 1 }}>
                      ...
                      <Grid size={{ xs: 12, sm: 6 }}>
                        <TreatmentTypeRadioButtons
                          label='Continue to existing ID'
                          radioPosition='right'
                          backgroundColor={theme.palette.customColors.OnPrimary}
                          borderColor='#839D8D'
                          isSelected={field.value === 'existing'}
