              ...
              <KeenSliderWrapper>
                <Grid container spacing={3} className='match-height'>
                  <Grid item size={{ xs: 12, md: 3, sm: 6 }}>
                    <DashboardCardHeader title={t('key_insights')}>
                      <Box sx={{ p: 6 }}>
                  ...
                  <Grid item size={{ xs: 12, md: 3, sm: 6 }}>
                    <DashboardCardHeader title={t('animal_activity')}>
                      <AnimalActivityChart animalActivityData={animalActivityData} />
                    </DashboardCardHeader>
                  </Grid>
                  <Grid item size={{ xs: 12, md: 3, sm: 6 }}>
                    <DashboardCardHeader title={t('animal_transfer')}>
                      <Box sx={{ p: 6 }}>
                  ...
                  <Grid item size={{ xs: 12, md: 3, sm: 6 }}>
                    <DashboardCardHeader title={t('eggs')}>
                  ...
                  <Grid item size={{ xs: 12, md: 2.5, sm: 6 }}>
                    <DashboardCardHeader title={t('pending_requests_pharmacy')} isSmall={true}>
                      <PharmacyPendingReqChart pendingRequests={pendingRequests} />
                    </DashboardCardHeader>
                  </Grid>
                  <Grid item size={{ xs: 12, md: 2.5, sm: 6 }}>
                    <DashboardCardHeader title={t('notes')}>
                      <DashboardNotes notesData={notes} />
                    </DashboardCardHeader>
                  </Grid>
                  <Grid item size={{ xs: 12, md: 2.5, sm: 6 }}>
                    <DashboardCardHeader title={t('lab_requests')}>
