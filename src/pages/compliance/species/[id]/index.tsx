...
const SpeciesDetails = () => {
  ...
  useEffect(() => {
    const { page = '1', limit = '50', q = '', column = '', sort = 'asc' } = router.query as Record<string, string>
  ...
  const handleReportExport = async () => {
    ...
    try {
      ...
      await getSpeciesShipmentList({ params: params as any, id: id as string }).then(res => {
        if (res?.success === true) {
