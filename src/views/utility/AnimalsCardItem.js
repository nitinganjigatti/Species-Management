...
const AnimalCardItem = ({ species, children, theme, tempSelectedSpecies, selectionType, speciesview }) => {
  return (
    <ListItem
      key={species.id}
      secondaryAction={
      ...
      sx={{
        ...
        borderRadius: '8px',
        border: tempSelectedSpecies.includes(species.animal_id) ? '1px solid' + theme.palette.primary.main : '',
        mb: 3,
