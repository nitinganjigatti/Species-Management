...
interface NecropsyAnalyticsProps {
  disabled?: boolean
  filterDate?: DateFilter
  setFilterDate?: (dateFilter: DateFilter) => void
  badgeCount?: number
  onCarcassTransfer?: () => void
  allowCarcassCollection?: boolean
  showCarcassTransferButton?: boolean
  showBackButton?: boolean
  onBack?: () => void
  title?: string
}

const NecropsyAnalytics: FC<NecropsyAnalyticsProps> = ({
  disabled = false,
  filterDate,
  setFilterDate,
  badgeCount = 1,
...
export default memo(NecropsyAnalytics)
