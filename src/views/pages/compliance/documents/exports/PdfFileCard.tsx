...
interface PdfFileCardProps {
  media: PdfFileCardMedia
  isBorderedCard?: boolean
}

const PdfFileCard = ({ media, isBorderedCard = false }: PdfFileCardProps) => {
  ...
  return (
    <Card
      sx={theme => ({
        ...
        position: 'relative',
        cursor: 'pointer',
        border: isBorderedCard ? `1px solid ${theme.palette.grey[300]}` : undefined, // For bordered card
        boxShadow: isBorderedCard ? 'none' : undefined // default shadow
      })}
