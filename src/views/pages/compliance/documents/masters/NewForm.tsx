...
interface NewFormProps {
  name?: string
  control: Control<NewFormValues>
  errors?: FieldErrors<NewFormValues>
  handleSubmit: UseFormHandleSubmit<NewFormValues>
  onSubmit: (data: NewFormValues) => void | Promise<void>
...
export const useTradePartiesForm = (defaultValues: NewFormValues) =>
