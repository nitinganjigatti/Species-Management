...
import { Box, Typography, Grid, CircularProgress, CardContent } from '@mui/material'
...
const BasicDetails = ({ airwaybillvalue, fileNumberValue, selectedId, startDate, uploadedFile, loader }: BasicDetailsProps) => {
