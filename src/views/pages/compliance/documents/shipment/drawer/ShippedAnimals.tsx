...
interface ShippedAnimalsDrawerProps {
  open: boolean
  onClose: () => void
  title: string
  identifiers?: unknown[]
    ...
    <Drawer open={open} anchor='right'>
      ...
      >
        ...
        <Box sx={{ px: 5, pb: 6, pt: 2 }}>
          ...
          <Box mt={3}>
            {tab === 0 && <SpeciesDetails selectedExportData={selectedExportData as any} />}
            {tab === 1 && <AnimalIdentifiers selectedExportData={selectedExportData as any} />}
          </Box>
        </Box>
      </Box>
    </Drawer>
