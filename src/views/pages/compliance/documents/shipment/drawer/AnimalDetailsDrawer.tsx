...
interface AnimalDetailsDrawerProps {
  ...
  setSelectedSpeciesData: React.Dispatch<React.SetStateAction<AnimalDetailsData>>
}
...
const AnimalDetailsDrawer = ({
  ...
  const handleClick = () => {
    ...
    setCurrentSpeciesId(animalDetails.tsn_id ?? null)
    ...
    >
      ...
      >
        ...
        <Box sx={{ px: '20px', pb: 2 }}>
          ...
          >
            {(animalDetails?.animals?.length ?? 0) > 0 ? (
