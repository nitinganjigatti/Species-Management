...
import { Box, Card, CardContent, CardHeader, Drawer, Grid, IconButton, Typography } from '@mui/material'
          ...
          <Grid size={{ md: 4, sm: 4, xs: 4 }}>
            {tabsForfilter.map(menu => {
              ...
              if (menu === 'Site') {
                ...
                count = (tempSelectedItems as Record<string, unknown>)?.reportType ? 1 : 0
