...
import { getAllEnclosures, getAllSections, getAllSites } from 'src/lib/api/housing'
...
const MENU_ORDER: MenuKey[] = [MENU.ORGANIZATIONS, MENU.LOCATION, MENU.SPECIES, MENU.GENDER, MENU.AGE]
...
const SELECT_ALL_ENABLED = new Set<MenuKey>([MENU.ORGANIZATIONS, MENU.LOCATION, MENU.SPECIES, MENU.GENDER, MENU.AGE])
