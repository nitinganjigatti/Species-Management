...
const MENU_ORDER = [MENU.ORGANIZATIONS, MENU.LOCATION, MENU.SPECIES, MENU.GENDER, MENU.AGE]
...
const SELECT_ALL_ENABLED = new Set([MENU.ORGANIZATIONS, MENU.LOCATION, MENU.SPECIES, MENU.GENDER, MENU.AGE])
