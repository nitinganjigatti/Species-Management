import { Drawer, Box, Typography, IconButton, Divider, Card, Button, FormControl, FormLabel, RadioGroup, FormControlLabel, Radio } from '@mui/material'
...
const EditAlternativeMedicineDrawer = ({
    ...
    >
      ...
      <Box display='flex' justifyContent='space-between' alignItems='center' sx={{ p: 4 }}>
        <Typography variant='h6' fontWeight='bold'>Edit Alternative Medicine</Typography>
        <IconButton onClick={onClose}><Icon icon='mdi:close' /></IconButton>
      </Box>
      <Divider />
