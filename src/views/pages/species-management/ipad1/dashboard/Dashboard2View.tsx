...
const FireTile: React.FC<{ tile: Tile; count: number; onOpen: () => void }> = ({ tile, count, onOpen }) => {
  ...
  return (
    ...
    >
      ...
      <Typography sx={{ fontSize: '2rem', fontWeight: 800, lineHeight: 1, color: numColor, letterSpacing: '-0.01em' }}>
        {count}
      </Typography>
...
const StatusTile: React.FC<{ tile: Tile; value: string; ok: boolean; note: string; onOpen: () => void }> = ({ tile, value, ok, note, onOpen }) => {
  ...
  return (
    ...
    >
      ...
      <Typography sx={{ fontSize: '1.5rem', fontWeight: 800, lineHeight: 1.05, color: 'customColors.OnSurfaceVariant', letterSpacing: '-0.01em' }} noWrap>
        {value}
      </Typography>
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1fr 1fr' }, gap: 4 }}>
          ...
          >
            <Box sx={{ display: 'flex', alignItems: 'baseline', gap: 1.5, flexWrap: 'wrap' }}>
              <Typography sx={{ fontSize: '1.6rem', fontWeight: 800, color: data.obligations.threatenedAtRisk ? cc.Tertiary : 'primary.dark', lineHeight: 1 }}>
