...
import { SectionCard, MiniBarRow, EmptyState } from 'src/views/pages/species-management/ipad1/detail/detailUi'
import {
  SexDonut,
  ProportionChart,
  ColumnBarChart,
  ...
  type Tone
} from 'src/views/pages/species-management/ipad1/dashboard/dashboardUi'
...
import type { DetailAlerts } from 'src/views/pages/species-management/ipad1/detail/SpeciesDetailView'
