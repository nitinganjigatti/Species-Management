...
import { SectionCard, MiniBarRow, EmptyState } from 'src/views/pages/species-management/detail2/detailUi'
import {
  SexDonut,
  ProportionChart,
  RankedBarChart,
...
import {
  ...
  CTRL_H,
  type FacetDef
} from 'src/views/pages/species-management/detail2/tabs/CircleOfLifeTab'
...
import type { DetailAlerts } from 'src/views/pages/species-management/detail2/SpeciesDetailView'
