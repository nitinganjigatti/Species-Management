...
// no persistent sidebar). Pages under /species-management/ipad-3/ render inside
...
const NAV_ITEMS: NavItem[] = [
  { key: 'dashboard', label: 'Dashboard', icon: 'mdi:view-dashboard-outline', path: '/species-management/ipad-3/dashboard' },
  { key: 'species', label: 'Species', icon: 'mdi:paw', path: '/species-management/ipad-3/list' }
]
