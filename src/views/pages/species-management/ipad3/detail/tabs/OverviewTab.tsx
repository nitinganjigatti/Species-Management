...
import { SectionCard, EmptyState } from 'src/views/pages/species-management/ipad3/detail/detailUi'
import {
  SexDonut,
  ProportionChart,
  type CompositionSegment
} from 'src/views/pages/species-management/ipad3/dashboard/dashboardUi'
import { BarColumns, RankRows } from 'src/views/pages/species-management/ipad3/marks'
import DashboardDateRange, { type RangeSelection } from 'src/views/pages/species-management/ipad3/dashboard/DashboardDateRange'
import {
  GenderFilter,
  PeriodBand,
  RangeSelect,
  ...
  CTRL_H,
  type FacetDef
} from 'src/views/pages/species-management/ipad3/detail/tabs/CircleOfLifeTab'
...
import type { DetailAlerts } from 'src/views/pages/species-management/ipad3/detail/SpeciesDetailView'
