...
const AnimalEventsTable: React.FC<{
  ...
  // ELASTIC (user call 2026-09-05): the search fills the row's free space and yields
  // only what the other controls need — Custom's year selects squeeze it, never an icon.
  const searchField = (
