// ═══════════════════════════════════════════════════════════════════════════════
// iPad 3 SKIN — the Command Centre design language, lifted verbatim from
// /Users/nitin/Project/command-centre-Naveen (src/index.css + src/exec/system.tsx).
// This file is the ONE place iPad 3's look is decided; every ipad3 component reads
...
/** iPad 3 detail tab rail (user hexes, 2026-09-01) — the active pill goes slate-navy
 *  with the banner-green icon inside; resting icons wear the same slate-navy. */
export const TAB_PILL = '#1f515b' // active tab pill fill
export const TAB_ICON_ON = '#52f990' // icon inside the active pill
export const TAB_ICON_OFF = '#1f515b' // icons on resting (non-active) tabs
 ...
 *  2026-09-01) and semantic figure inks (all three inks = existing antz theme tokens). */
export const BANNER_GRAD = 'linear-gradient(119.68089465958582deg, rgb(37,93,104) 3.3851%, rgb(22,54,79) 67.734%)'
// Same ramp at 90% — laid over the species photo so it ghosts through the banner
// (the Figma layer is exactly this 0.9-alpha gradient over the full-bleed photo).
export const BANNER_GRAD_SCRIM =
  'linear-gradient(119.68089465958582deg, rgba(37,93,104,0.9) 3.3851%, rgba(22,54,79,0.9) 67.734%)'
