...
import SpeciesListAnalysisFilter from 'src/views/pages/species-management/ipad3/list/SpeciesListAnalysisFilter'
import { compactNumber, type AnalysisFilter, type SpeciesFilters } from 'src/views/pages/species-management/ipad3/list/speciesListing.utils'
