...
import { SectionCard, useTone, thinScrollbarSx } from 'src/views/pages/species-management/ipad3/detail/detailUi'
import * as skin from 'src/views/pages/species-management/ipad3/skin'
import { BarColumns, RankRows, SliceKey, Slices, fmt } from 'src/views/pages/species-management/ipad3/marks'
