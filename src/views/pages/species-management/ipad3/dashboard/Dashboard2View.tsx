...
import DashboardSpeciesPicker, { SpeciesOption } from 'src/views/pages/species-management/ipad3/dashboard/DashboardSpeciesPicker'
import { TaxonomyStatusStrip } from 'src/views/pages/species-management/ipad3/dashboard/dashboardUi'
import { BarColumns } from 'src/views/pages/species-management/ipad3/marks'
import { SectionCard, EmptyState, DetailTable , SheetDrawer} from 'src/views/pages/species-management/ipad3/detail/detailUi'
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
        ...
        <TextField
          ...
          sx={{
            width: 280,
            maxWidth: '100%',
            // white sheet → the quiet grey pill (contextual search standard, 2026-09-01)
            '& .MuiInputBase-root': { backgroundColor: skin.FIELD_BG, borderRadius: '999px' },
