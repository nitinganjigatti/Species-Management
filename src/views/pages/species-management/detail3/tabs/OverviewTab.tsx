...
import { SectionCard, MiniBarRow, EmptyState } from 'src/views/pages/species-management/detail3/detailUi'
import {
  SexDonut,
  ProportionChart,
  RankedBarChart,
...
import {
  ...
  CTRL_H,
  type FacetDef
} from 'src/views/pages/species-management/detail3/tabs/CircleOfLifeTab'
import { EMPTY_ANALYSIS, type AnalysisFilter } from 'src/views/pages/species-management/list3/speciesListing.utils'
import type {
  SpeciesDetailHeader,
  SpeciesDetailTab,
  SpeciesHousing,
...
import type { DetailAlerts } from 'src/views/pages/species-management/detail3/SpeciesDetailView'
