...
import { DetailTable, EmptyState, Pill, SectionCard, SeasonalColumnChart, StatTile, StatusChip, TileGrid } from 'src/views/pages/species-management/detail3/detailUi'
