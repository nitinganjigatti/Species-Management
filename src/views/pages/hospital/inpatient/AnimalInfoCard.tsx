...
const AnimalInfoCard = ({ backgroundColor, additionalFields, image, name, scientificName, age, gender, isLoading }: AnimalInfoCardProps) => {
  const theme: any = useTheme()

  const StatBox = ({ label, value, isStatusCard }: { label?: any; value?: any; isStatusCard?: boolean }) => {
  ...
  return (
    ...
    >
      <Grid container rowSpacing={4} columnSpacing={4} alignItems='center'>
        ...
        {additionalFields?.map(({ label, value, isStatusCard }: any, index: number) => (
