...
const MedicinePrescriptionCardForMultipleTimeSlots = ({
  ...
  }, [open, dosageEntries, isDetailLoading, selectedMedications, isControlledSubstance])
  ...
  const formatDisplayDateTime = (dateTimeString: string) => {
    ...
    const utcDate = new Date(Date.UTC(Number(year), Number(month) - 1, Number(day), ...(timePart.split(':') as any)))
