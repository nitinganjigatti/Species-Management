      ...
      >
        ...
        >
          <Box sx={{ mt: 2, display: 'flex', flexDirection: 'row', gap: 2 }}>
            ...
            <Typography variant='h6'> {t('animals_module.revoke_mortality')}</Typography>
          </Box>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              >
                ...
                <ControlledTextArea
                  control={control}
                  name={'reason'}
                  label={t('animals_module.enter_reason') as string}
                />
              </Card>
            </form>
          </Box>
        ...
        >
          ...
          >
            {loading ? <CircularProgress size={24} color='inherit' /> : t('animals_module.revoke_mortality')}
          </Button>
        </Box>
      </Drawer>
    </>
