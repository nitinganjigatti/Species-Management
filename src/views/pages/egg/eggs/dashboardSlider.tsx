  ...
  return (
    <Drawer
      ...
      sx={{
        ...
        gap: '24px',
        backgroundColor: (theme.components?.MuiDialog?.styleOverrides?.paper as any)?.backgroundColor || 'background.default'
      }}
    >
      <Box
        ...
        sx={{
          ...
          bgcolor: (theme.components?.MuiDialog?.styleOverrides?.paper as any)?.backgroundColor || 'background.default'
        }}
      >
      ...
      >
        <Box sx={{ pb: '24px', pt: '85px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
          {drawerLoading ? (
            ...
            drawerList?.length > 0 &&
            drawerList?.map((item: any, index: any) => (
              <Box
                key={index}
                sx={{
