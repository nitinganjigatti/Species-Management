...
const EggFirstSection: any = ({ getActivityLogsFunc, eggDetails, getDetails, GetGalleryImgList, handleBackButton }: any) => {
        ...
        <CardContent sx={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <Grid container>
                    ...
                    <>
                      <Box sx={{ position: 'relative' }} className='navigation-wrapper'>
                        <Box sx={{ position: 'absolute' }} ref={sliderRef} className='keen-slider'>
                          {eggDetails?.egg_images?.map((item: any) => (
            ...
            >
              ...
              >
                <Grid
                  size={{ xs: 12, sm: 6, md: 12, lg: 4, xl: 4 }}
                  sx={{
                    display: 'flex',
                    height: '88px',
