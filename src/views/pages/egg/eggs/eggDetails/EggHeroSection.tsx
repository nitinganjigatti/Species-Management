...
import { EggHeroSectionProps } from 'src/types/egg/components'

const EggHeroSection: FC<EggHeroSectionProps> = ({ getActivityLogsFunc, eggDetails, getDetails, GetGalleryImgList, handleBackButton }) => {
  ...
  const calculatePercentageChange = (value1: any, value2: any) => {
  ...
  const ConditionCard = () => (
    <Box
      sx={{
        ...
        height: '88px',
        backgroundColor:
          eggDetails?.egg_status === 'Fresh' || eggDetails?.egg_status === 'Fertile' || eggDetails?.egg_status === 'Hatched'
    ...
    >
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 4 }}>
        ...
        >
          <Avatar
            src={
              eggDetails?.egg_status === 'Fresh' || eggDetails?.egg_status === 'Fertile'
        ...
        <CardContent sx={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <Grid container>
            ...
            >
              ...
              >
                <Grid size={{ xs: 12, sm: 5.8, md: 12, lg: 3.9, xl: 3.75 }}>
                  <TimeCard />
                </Grid>
                <Grid size={{ xs: 12, sm: 5.8, md: 12, lg: 3.9, xl: 3.75 }}>
                  <WeightCard />
                </Grid>
                <Grid size={{ xs: 12, lg: 3.9, xl: 3.75 }}>
                  <ConditionCard />
                </Grid>
              </Grid>
            </Grid>
