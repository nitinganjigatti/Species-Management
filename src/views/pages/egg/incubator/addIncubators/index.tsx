...
const AddIncubators: any = ({
  ...
  const fetchNurseryList = async (q = '', nurseryId: any) => {
    try {
  ...
  const fetchRoomList = async (nurseryId: any, q = '') => {
    try {
      setRoomLoader(true)
  ...
  const handleFormSubmit = async (data: any) => {
    ...
    try {
      const res = isEdit ? await updateIncubator(id as string, incubatorPayload) : await addIncubator(incubatorPayload)
          ...
          >
            ...
            >
                  ...
                  render={({ field: { value, onChange } }) => (
                    <Autocomplete
                      ...
                      renderInput={params => (
                        <TextField
                          onChange={e => {
                            searchNursery(e.target.value, undefined)
                          }}
                          {...params}
              ...
              <FormControl fullWidth>
                ...
                />
                {errors?.room && <FormHelperText sx={{ color: 'error.main' }}>{String(errors?.room?.message)}</FormHelperText>}
              </FormControl>
              <FormControl fullWidth>
                <Controller
                  name='incubator_name'
                ...
                {errors.incubator_name && (
                  <FormHelperText sx={{ color: 'error.main' }}>{String(errors.incubator_name?.message)}</FormHelperText>
                )}
              </FormControl>
              <FormControl fullWidth>
                <Controller
                ...
                {errors.maxNumberOfEggs && (
                  <FormHelperText sx={{ color: 'error.main' }}>{String(errors.maxNumberOfEggs?.message)}</FormHelperText>
                )}
              </FormControl>
            </Box>
          </Box>
