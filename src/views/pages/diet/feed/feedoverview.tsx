...
interface Props {
  isActive: any
  setIsActive: (...args: any[]) => any
  FeedDetailsValue: any
  permission: any
}

const FeedOverview: React.FC<Props> = ({ isActive, setIsActive, FeedDetailsValue, permission }) => {
  const { t } = useTranslation()
  const [activePayload, setActivePayload] = useState<any>(FeedDetailsValue?.active || false)
