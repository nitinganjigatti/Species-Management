...
interface Props {
  selectedEnclosureDrawer: any
  setSelectedEnclosureDrawer: (...args: any[]) => any
  selectedItems: any[]
  selectEnclosures: any[]
  selectedEnclosureIds: any[]
  loader: any
  setSelectedEnclosureIds: (...args: any[]) => any
  checkedRows: any[]
  setSelectedItems: (...args: any[]) => any
  setCheckedRows: (...args: any[]) => any
}

const SelectedEnclosure: React.FC<Props> = ({
  ...
  const handleRemove = (index: number) => {
    ...
    const updatedIds = updatedItems.map((item: any) => item.enclosure_id)
