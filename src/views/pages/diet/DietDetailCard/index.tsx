...
interface Props {
  dietDetails: any
  dietModuleAccess: any
  refreshDietDetails: (...args: any[]) => void
  handleSpeciesClick: (...args: any[]) => void
  handleSpeciesClicknew: (...args: any[]) => void
  setapplyfilterCheck: (...args: any[]) => void
  authData: any
  onDownloadPdf?: (...args: any[]) => void
...
const DietDetailCard = ({
  ...
  const [isActive, setIsActive] = useState<any>(dietDetails?.active || '0')

  const [activePayload, setActivePayload] = useState<any>(false)
