...
const NurseryList: FC = () => {
  ...
  const fetchTableData = useCallback(
    async (q: string = '', siteId: string | null = ''): Promise<void> => {
      setLoading(true)
  ...
  const searchTableData = useCallback(
    debounce((q: string, siteId: string | null): void => {
  ...
  const indexedRows = rows?.map((row: any, index: number) => ({ ...row, id: row.nursery_id, sl_no: getSlNo(index) }))
