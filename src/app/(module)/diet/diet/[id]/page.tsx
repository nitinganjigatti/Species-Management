...
import DietDetailCard from 'src/views/pages/diet/DietDetailCard'
                                    ...
                                    {dietDetails?.meal_data?.length > 0 ? (
                                      <TableBody>
                                        {dietDetails.meal_data?.map((itemd: any, index: any) => {
                                          ...
                                          const recipeList = itemd?.recipe || []
                                          const comboList = itemd?.combo || []
                                          const ingredientList = itemd?.ingredient || []
                                          const iwcList = itemd?.ingredientwithchoice || []
                                          const totalSubRows =
                                            recipeList.length + comboList.length + ingredientList.length + iwcList.length
                                          const firstSubRowType =
                                            recipeList.length > 0
                                              ? 'recipe'
                                              : comboList.length > 0
                                                ? 'combo'
                                                    ...
                                                    {itemd?.recipe?.length > 0 &&
                                                      itemd?.recipe?.map((item: any, index: any) => {
                                                        return (
                                                          ...
                                                          >
                                                            {firstSubRowType === 'recipe' && index === 0 && mealNameCell}
                                                            <TableCell
                                                                      ...
                                                                      ? item.meal_type.map((meal: any, i: any) =>
                                                                        meal.meal_value_header === 'Generic' &&
                                                                          ...
                                                                          <Typography
                                                                            component='span'
                                                                            key={i}
                                                                            sx={{ textAlign: 'center', display: 'block', mt: '4px' }}
                                                                          >
                                                    ...
                                                    {itemd?.combo?.length > 0 &&
                                                      itemd?.combo?.map((item: any, index: any) => {
                                                        return (
                                                          ...
                                                          >
                                                            {firstSubRowType === 'combo' && index === 0 && mealNameCell}
                                                            <TableCell
                                                              style={{ paddingLeft: '0px' }}
                                                              sx={{
                                                                position: isSmallDevice ? '' : 'sticky ',
                                                    ...
                                                    {itemd?.ingredient?.length > 0 &&
                                                      itemd?.ingredient?.map((item: any, index: any) => {
                                                        return (
                                                          ...
                                                          >
                                                            {firstSubRowType === 'ingredient' && index === 0 && mealNameCell}
                                                            <TableCell
                                                              style={{ paddingLeft: '0px' }}
                                                              sx={{
                                                                position: isSmallDevice ? '' : 'sticky ',
                                                  ...
                                                  <>
                                                    {itemd?.ingredientwithchoice?.map((item: any, index: any) => {
                                                      return (
                                                        ...
                                                        >
                                                          {firstSubRowType === 'iwc' && index === 0 && mealNameCell}
                                                          <TableCell
                                                            style={{ paddingLeft: '0px' }}
                                                            sx={{
                                                              position: isSmallDevice ? '' : 'sticky ',
