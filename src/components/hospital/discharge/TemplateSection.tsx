...
import SurgeryRecordTemplateListRaw from 'src/views/pages/hospital/inpatient/SurgeryRecordTemplateList'

const RichTextEditor: any = RichTextEditorRaw
...
const mapTemplateRecord = (record: any): any => {
...
// Save  template bar
const SaveTemplateBar = ({ onClose, onSave, loading = false, richNote }: SaveTemplateBarProps) => {
        ...
        {isTemplatesLoading ? (
          ...
          templateLabels?.length > 0 && (
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              ...
              >
                <Box sx={{ display: 'inline-flex', gap: 3, pr: 1 }}>
                  {templateLabels?.map((templateLabel: any) => {
