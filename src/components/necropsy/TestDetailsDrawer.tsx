      ...
      slotProps={{
        paper: {
          sx: {
            ...
            backgroundColor: (theme.palette as any).customColors?.OnPrimary || theme.palette.background.paper
          }
        }
      }}
    >
        ...
        <Box sx={{ flex: 1 }}>
          ...
          {selectedTest?.sampleName && (
            <Typography
              sx={{
                fontSize: '13px',
                color: (theme.palette as any).customColors?.neutralSecondary || theme.palette.text.secondary
              }}
            >
              {selectedTest.sampleName}
            </Typography>
      ...
      <Box sx={{ flex: 1, overflowY: 'auto', backgroundColor: theme.palette.background.default }}>
        {loading ? (
          ...
          <Box sx={{ p: 3 }}>
            ...
            >
              {subTests.map((subTest: SubTest, index: number) => (
                <Box
