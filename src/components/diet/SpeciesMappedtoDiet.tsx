...
interface SpeciesMappedtoDietProps {
  isOpen: boolean
  setIsOpen: (open: boolean) => void
  setIsOpennew: (open: boolean) => void
  speciesData: any[]
  selectedSpecies: any[]
  ...
  setSelectedSpeciesIds: (ids: any[]) => void
  setSelectedTaxonomyIds: (ids: any[]) => void
  speciesview: string
  checkForSite: string
  ...
  setSelectedSpecies: (species: any[]) => void
  setCheckForSite: (val: string) => void
  fetchList: (query: string) => void
  removeFilterTriggered: boolean
  setRemoveFilterTriggered: (val: boolean) => void
}

const SpeciesMappedtoDiet: React.FC<SpeciesMappedtoDietProps> = ({
  isOpen,
  setIsOpen,
  setIsOpennew,
  speciesData,
