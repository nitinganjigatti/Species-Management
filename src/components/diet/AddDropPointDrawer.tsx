...
interface Props {
  ...
  selectedOption: any
  selectedMealGroups: any[]
  mealGroupsList: any[]
  siteName?: string
  fetchEnclosure?: () => void
  onRemoveMealGroup?: (id: any) => void
}

const AddDropPointDrawer: React.FC<Props> = ({
  openDrawer,
  handleCloseSideBar,
  selectedOption,
  selectedMealGroups,
  ...
  const [dropPointList, setDropPointList] = useState<any[]>([])
  const [dropPointLoading, setDropPointLoading] = useState<boolean>(false)
    ...
    >
      <Box
        sx={{
          ...
          p: 3,
          borderBottom: `1px solid ${(theme as any).palette.divider}`
        }}
      >
      ...
      <Box sx={{ p: 3, flex: 1, overflowY: 'auto' }}>
        ...
        <Card
          sx={{
            p: 2,
            mb: 3,
            backgroundColor: (theme as any).palette.customColors.lightBg,
            boxShadow: 'none',
        ...
        <Box sx={{ mb: 2 }}>
          <ControlledAutocomplete
            ...
            onInputChange={(value: any, reason: any) => {
      ...
      <Box
        sx={{
          p: 3,
          borderTop: `1px solid ${(theme as any).palette.divider}`,
          display: 'flex',
          gap: 2,
      ...
      >
        <Button
          ...
          sx={{
            borderRadius: '4px',
            color: (theme as any).palette.customColors.OnSurfaceVariant,
            borderColor: (theme as any).palette.customColors.Outline,
            '&:hover': {
              borderColor: (theme as any).palette.customColors.Outline,
