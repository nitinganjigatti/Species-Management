...
interface Props {
  isOpennew: boolean
  setIsOpennew: (...args: any[]) => any
  onSelectedSpeciesChange: (...args: any[]) => any
  setSelectedSpecies: (...args: any[]) => any
  speciesData: any[]
  speciesview: any
  dietDetails: any
  dietId: any
  refreshSpeciesData: (...args: any[]) => any
  ...
  selectionType: any
  setapplyfilterCheck: (...args: any[]) => any
  siteId: any
...
const ListOfSpeciesMapped: React.FC<Props> = ({
  ...
  const [primaryStatus, setPrimaryStatus] = useState<Record<string, any>>({})
