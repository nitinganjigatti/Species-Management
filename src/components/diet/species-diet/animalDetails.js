...
function AnimalDetails({ animalDetailsDrawer, setAnimalDetailsDrawer, animalId, setAnimalId, fetchTableData }) {
  ...
  const [uploadDietDrawer, setUploadDietDrawer] = useState(false)
  ...
  const updateAttachmentStatus = async (nextStatus, attachmentId) => {
          ...
          <>
            ...
            <TabContext sx={{ width: '100%' }} value={status}>
              ...
              <TabPanel value='1'>
                ...
                >
                  {animalDetails?.active_attachments?.map((item, index) => (
              ...
              <TabPanel value='0'>
                ...
                >
                  {animalDetails?.deactive_attachments?.map((item, index) => (
