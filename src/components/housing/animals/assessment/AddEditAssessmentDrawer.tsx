...
const AddEditAssessmentDrawer: React.FC<AddEditAssessmentDrawerProps> = ({
  open,
  setOpen,
  assessment,
  selectedValue,
  ...
  const isEditMode = !fromAddIcon && selectedValue && userId === selectedValue.created_by && isAnimalAlive
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      if (isAddMode) {
        ...
        const payload = {
          animal_assessment_id: selectedValue.assessment_id,
          assessment_type_id: assessment.assessment_type_id,
          assessment_value: assessmentValue,
          comments: data.notes || '',
          recorded_date_time: recordedDateTime,
...
export default AddEditAssessmentDrawer
