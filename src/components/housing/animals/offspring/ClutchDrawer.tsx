    ...
    <>
      ...
      >
          ...
          <Box>
            ...
            >
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mx: 4, my: 3 }}>
                ...
                <StyledTypography>
                  Discarded: <span style={{ fontWeight: 600 }}>{clutchDetails?.deathdiscarded_count_count || 0}</span>
                </StyledTypography>
                <StyledTypography>
        ...
        <Box sx={{ px: 4 }}>
          ...
          >
            <Tab value='eggs' label={`Eggs - ${clutchDetails?.total_egg_count ?? 0}`} />

            <Tab value='animals' label={`Animals - ${clutchDetails?.hatched_count ?? 0}`} />
          </Tabs>
        </Box>
