...
interface IncidentDetailItem {
  ...
  reported_by_profile_pic?: string
...
interface IncidentDetailsCardProps {
  ...
  index: number
  data: IncidentDetailItem[] | undefined
}
      ...
      >
        ...
        >
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <FallbackAvatar src={item?.reported_by_profile_pic} sx={{ borderRadius: '50%', width: 34, height: 34 }} onLoad={() => {}} onError={() => {}} />
            <Box>
              <Typography
                sx={{
                  fontSize: 14,
