...
import SpeciesDetailView from 'src/views/pages/species-management/detail3/SpeciesDetailView'
import OverviewTab from 'src/views/pages/species-management/detail3/tabs/OverviewTab'
import ProfileTab from 'src/views/pages/species-management/detail3/tabs/ProfileTab'
import PairingTab from 'src/views/pages/species-management/detail3/tabs/PairingTab'
import HousingTab from 'src/views/pages/species-management/detail3/tabs/HousingTab'
import CircleOfLifeTab from 'src/views/pages/species-management/detail3/tabs/CircleOfLifeTab'
import EggsTab from 'src/views/pages/species-management/detail3/tabs/EggsTab'
import AssessmentsTab from 'src/views/pages/species-management/detail3/tabs/AssessmentsTab'
import MedicalTab from 'src/views/pages/species-management/detail3/tabs/MedicalTab'
import HospitalTab from 'src/views/pages/species-management/detail3/tabs/HospitalTab'
import IdentificationTab from 'src/views/pages/species-management/detail3/tabs/IdentificationTab'
import BreedsTab from 'src/views/pages/species-management/detail3/tabs/BreedsTab'
...
const SpeciesDetail3Container = () => {
  ...
  const clinical = useTabQuery(['sm-clinical', id], () => detailApi.getSpeciesClinical(id), tab === 'medical' || tab === 'hospital')
  ...
  return (
    <SpeciesDetailView
      ...
      activeTab={tab}
      onTabChange={setTab}
      onBack={() => router.push('/species-management/list-3/')}
      showEggs={showEggs}
      alerts={alerts}
...
export default SpeciesDetail3Container
