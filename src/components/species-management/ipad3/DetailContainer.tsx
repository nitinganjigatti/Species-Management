...
import SpeciesDetailView from 'src/views/pages/species-management/ipad3/detail/SpeciesDetailView'
...
import EggsTab from 'src/views/pages/species-management/ipad3/detail/tabs/EggsTab'
import AssessmentsTab from 'src/views/pages/species-management/ipad3/detail/tabs/AssessmentsTab'
import MedicalTab from 'src/views/pages/species-management/ipad3/detail/tabs/MedicalTab'
import HospitalTab from 'src/views/pages/species-management/ipad3/detail/tabs/HospitalTab'
