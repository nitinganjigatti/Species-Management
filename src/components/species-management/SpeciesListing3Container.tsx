...
import SpeciesListingView, { type AppliedChip, type PostureStats } from 'src/views/pages/species-management/list3/SpeciesListingView'
import { type FilterOption } from 'src/components/species-management/SpeciesManagementFilterDrawer2'
import { type MajorFilterRow } from 'src/views/pages/species-management/list3/SpeciesListMajorFilters'
import { useSpeciesChrome } from 'src/components/species-management/useSpeciesChrome'
import { buildSpeciesColumns } from 'src/views/pages/species-management/list3/speciesColumns'
import {
  EMPTY_ANALYSIS,
  EMPTY_FILTERS,
  MONTH_LABELS,
  ...
  type SpeciesFilters,
  type SpeciesRow
} from 'src/views/pages/species-management/list3/speciesListing.utils'
...
const SpeciesListing3Container = () => {
  ...
  const handleCellClick = useCallback(
    (params: { field: string; row: Record<string, unknown> }) => {
      if (params.field === 'sl_no' || params.field === 'species_name') {
        router.push(`/species-management/list-3/${params.row.species_id}/`)
      }
    },
    [router]
  )
...
export default SpeciesListing3Container
