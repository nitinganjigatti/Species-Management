...
import SpeciesDetailView from 'src/views/pages/species-management/ipad1/detail/SpeciesDetailView'
import OverviewTab from 'src/views/pages/species-management/ipad1/detail/tabs/OverviewTab'
import ProfileTab from 'src/views/pages/species-management/ipad1/detail/tabs/ProfileTab'
import PairingTab from 'src/views/pages/species-management/ipad1/detail/tabs/PairingTab'
import HousingTab from 'src/views/pages/species-management/ipad1/detail/tabs/HousingTab'
import CircleOfLifeTab from 'src/views/pages/species-management/ipad1/detail/tabs/CircleOfLifeTab'
import EggsTab from 'src/views/pages/species-management/ipad1/detail/tabs/EggsTab'
import AssessmentsTab from 'src/views/pages/species-management/ipad1/detail/tabs/AssessmentsTab'
import MedicalTab from 'src/views/pages/species-management/ipad1/detail/tabs/MedicalTab'
import HospitalTab from 'src/views/pages/species-management/ipad1/detail/tabs/HospitalTab'
import LabTab from 'src/views/pages/species-management/ipad1/detail/tabs/LabTab'
import IdentificationTab from 'src/views/pages/species-management/ipad1/detail/tabs/IdentificationTab'
import BreedsTab from 'src/views/pages/species-management/ipad1/detail/tabs/BreedsTab'
import { V2TypeScale } from 'src/views/pages/species-management/ipad1/detail/detailUi'
  ...
  return (
    <V2TypeScale>
      <SpeciesDetailView
        ...
        activeTab={tab}
        onTabChange={setTab}
        onBack={() => router.push('/species-management/ipad-1/list/')}
        showEggs={showEggs}
        alerts={alerts}
