...
import SpeciesListingView, { type AppliedChip, type PostureStats } from 'src/views/pages/species-management/ipad1/list/SpeciesListingView'
import { type FilterOption } from 'src/components/species-management/SpeciesManagementFilterDrawer2'
import { type MajorFilterRow } from 'src/views/pages/species-management/ipad1/list/SpeciesListMajorFilters'
import { buildSpeciesColumns } from 'src/views/pages/species-management/ipad1/list/speciesColumns'
...
import {
  ...
  type SpeciesFilters,
  type SpeciesRow
} from 'src/views/pages/species-management/ipad1/list/speciesListing.utils'
  ...
  const handleCellClick = useCallback(
    (params: { field: string; row: Record<string, unknown> }) => {
      if (params.field === 'sl_no' || params.field === 'species_name') {
        router.push(`/species-management/ipad-1/list/${params.row.species_id}/`)
      }
    },
    [router]
  )
