...
import type { EditEggInfoProps } from 'src/types/egg/components'

const EditEggInfo: FC<EditEggInfoProps> = ({ eggDetails, openEditDrawer, closeEditDrawer, getDetails }) => {
          ...
          <form autoComplete='off' onSubmit={handleSubmit(onSubmit)}>
            ...
            >
              <FormControl fullWidth>
                ...
                />
                {errors?.egg_number && (
                  <FormHelperText sx={{ color: 'error.main' }}>{(errors.egg_number as any)?.message}</FormHelperText>
                )}
              </FormControl>
            </Box>
            <Box
