...
// Mock API
const getFilesList = async (params: { page: number; limit: number; q: string; sort?: string; sortBy?: string }) => ({
  success: true,
  data: {
    total: 60,
    records: Array.from<unknown, FileRecord>({ length: 10 }, (_, i) => ({
...
const addFile = async (data: unknown) => ({ success: true, message: 'File added' })
