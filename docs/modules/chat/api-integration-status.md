...
- **2026-05-21** — v1.1.3 leave/delete + per-chat drafts + audio duration + pin cap + add-as-admin + WhatsApp group-icon UX + component extractions + live presence + group-header member list:
