...
**Currently on `@antzsoft/chat-core@1.1.4`** (v1.1.3 added three-tier group leave/delete + `addParticipants` role param + `removeIcon` + sidebar/conversation pin cap; v1.1.4 is a non-breaking patch on top — see [package.json](../../../package.json)).
